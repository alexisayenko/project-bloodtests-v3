...
- 2026-09-11 — The Hormonal Pathways design is specified: [task-0024](tasks/task-0024.md), the [pathway](product/concepts/pathway.md) concept, and [ADR-0014](tech/decisions/adr-0014-pathway-wiring-is-mermaid-generated-to-json.md), which makes per-axis Mermaid wiring the source of a generated `pathways.json`.

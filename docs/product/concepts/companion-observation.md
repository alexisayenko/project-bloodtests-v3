...
Research comes first — per marker family, with sources and verbatim quotes, reviewed in `docs/product/companions-research.md` before the catalog is touched. Tracked in Alex's Nextcloud To Do List, not in `docs/tasks/`.

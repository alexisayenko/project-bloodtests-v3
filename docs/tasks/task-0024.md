...
> - **Hand-coded sample values**; no user data, month or provenance yet.
...
>   down to each, and a dashed ring around each target.
>
...
> the lazy load, `pathways.json` and its sidecar, the user's values, provenance
> and thickness, hover cards, the month stepper and the legend.

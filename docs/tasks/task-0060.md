...
- **Chips**: each particle carries its **apolipoprotein chip** (its identity —
  one ApoB per ApoB particle) and its **cargo chips** (TG, cholesterol,
  cholesterol esters), each with a status dot when a measured or computed value
  lands on it.
...
| Blood transport | Chylomicron | carrier | ApoB-48; TG, dietary cholesterol |
| Blood transport | Chylomicron remnant | carrier | ApoB-48 |
| Blood transport | VLDL | carrier | ApoB-100; TG, cholesterol |
| Blood transport | IDL | carrier | ApoB-100 |
| Blood transport | LDL | carrier | ApoB-100; cholesterol esters |
| Blood transport | Lp(a) | carrier | ApoB-100 **plus apo(a)** — an LDL-like particle; **not ApoA** |
| Blood transport | Nascent HDL | carrier | ApoA-I |
| Blood transport | Mature HDL | carrier | ApoA-I; cholesterol esters |
...
| TC/HDL (printed) | `9830-1` | yes | ratio badge, twin of `tchdl` |
...
| TC/HDL | `tchdl` | every cholesterol chip, HDL CE chip |
| Atherogenic coefficient | `ka` | every non-HDL cholesterol chip, HDL CE chip |
| LDL/HDL | `ldlhdl` | LDL CE chip, HDL CE chip |
...
A printed value and its computed twin (LDL-C `13457-7` vs `ldlf`, TC/HDL

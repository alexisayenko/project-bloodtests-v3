...
export const INDEX_DEFS: IndexDef[] = [
  ...
  },
  {
    ...
    consensus: 'Calculated free T (Vermeulen) is the method recommended by the Endocrine Society when free T is needed; direct analog free-T immunoassays are discouraged — they systematically under-read and are lab-specific (which is why the measured row can differ several-fold and only agrees on some assays). Sanity check: free T should be ~2% of total. A measured 23.6 pg/mL against a total T of 888 ng/dL is 0.27% — physiologically impossible; the calculated ~2.4% is the right order. So when the two rows disagree, trust the calculated one. ' +
      'Several other free-T calculations exist, but Vermeulen\'s is the only one implemented here. Södergård (1982) derived the same SHBG/albumin competitive-binding model and constants that Vermeulen\'s equation uses; for testosterone alone the two run numerically near-identical (r≈0.98 in one lab comparison), so adding it separately would add nothing new. Ly & Handelsman (2005) and Sartorius (2009) instead fit purely empirical regressions from total T and SHBG alone, with no albumin term — but their fitted coefficients sit behind the EJE / Ann Clin Biochem paywall and cannot be reproduced or verified here. Fiers et al. (2018) proposed no new formula, but tested Vermeulen\'s, Ly\'s and Zakharov\'s calculations against testosterone measured by direct equilibrium dialysis: Vermeulen\'s estimate ran only modestly high and independently of SHBG, T or albumin levels, while Zakharov\'s more complex allosteric model (2015) — despite agreeing well with equilibrium dialysis in its own validation — ran roughly twofold high in Fiers\' independent comparison (median cFT/ED-FT ratio 2.05). That combination — numerical redundancy, inaccessible coefficients, and reported inaccuracy — is why only Vermeulen is used. ' +
      'That same comparison quantifies cFT-V\'s own bias against directly measured (equilibrium dialysis) free T: a median 19% high in men (ratio 1.19, 2.5th–97.5th percentile 0.90–1.47; 1.33, range 0.75–2.76, in women), and the overestimate did not correlate with the patient\'s own SHBG (ρ=0.17), total T (ρ=0.02) or albumin (ρ=−0.01) — a constant, value-independent bias rather than one that worsens for a given patient, which is why Fiers still calls cFT-V "the most robust approximation" of the three and concludes it reflects a valid model of T binding to SHBG, not an error this app tries to correct.',
    evidenceLevel: 'guideline',
    references: [
      ...
      { organization: "Journal of Steroid Biochemistry (Södergård R, Bäckström T, Shanbhag V, Carstensen H)", document: "Calculation of free and bound fractions of testosterone and estradiol-17β to human plasma proteins at body temperature", year: 1982, url: "https://pubmed.ncbi.nlm.nih.gov/7202083/", doi: "10.1016/0022-4731(82)90038-3", quote: "A mathematical model for the calculation of free and protein bound concentrations of testosterone and estradiol in plasma is presented [based on] the concentration of albumin, the binding capacity of TeBG, and the association constants of the steroids to the two binding proteins... it was furthermore concluded that the androgen metabolites could be omitted from the calculations without affecting the calculated concentrations — the simplification to testosterone alone that Vermeulen's later quadratic relies on." },
      { organization: "European Journal of Endocrinology (Ly LP, Handelsman DJ)", document: "Empirical estimation of free testosterone from testosterone and sex hormone-binding globulin immunoassays", year: 2005, url: "https://pubmed.ncbi.nlm.nih.gov/15757865/", doi: "10.1530/eje.1.01844", quote: "Using a bootstrap regression modeling approach... empirical equations were developed for FT in terms of TT and SHBG [alone]... these simple, assumption-free empirical FT equations can estimate accurately blood FT from TT and SHBG measured in the same samples. (Abstract only — the fitted coefficients themselves are behind the journal paywall and were not accessible for verification.)" },
      { organization: "Annals of Clinical Biochemistry (Sartorius G, Ly LP, Sikaris K, McLachlan R, Handelsman DJ)", document: "Predictive accuracy and sources of variability in calculated free testosterone estimates", year: 2009, url: "https://pubmed.ncbi.nlm.nih.gov/19225026/", doi: "10.1258/acb.2008.008171", quote: "cFT formulae show wide discrepancies with equilibrium-binding algorithms showing systematic overestimation relative to direct FT measurements, whereas two empirical cFT methods were more concordant. (Abstract only — coefficients behind the journal paywall, not accessible for verification.)" },
      { organization: "Journal of Clinical Endocrinology & Metabolism (Fiers T, Wu F, Moghetti P, Vanderschueren D, Lapauw B, Kaufman JM)", document: "Reassessing Free-Testosterone Calculation by Liquid Chromatography-Tandem Mass Spectrometry Direct Equilibrium Dialysis", year: 2018, url: "https://pubmed.ncbi.nlm.nih.gov/29618085/", doi: "10.1210/jc.2017-02360", quote: "The median... ratios of calculated FT (cFT) over ED-FT... were 1.19 (0.9 to 1.47), 1.00 (0.69 to 1.42), and 2.05 (1.26 to 3.26) for cFT-V, cFT-L, and cFT-Z, respectively... cFT-V, although overestimating FT level, appears the most robust approximation, largely independent of SHBG, albumin, and T levels." },

...
export type PanelMeta = { color: string; icon: LucideIcon; description: string };
...
const META: Record<string, PanelMeta> = {
  ...
  'Fatty Liver':                 { color: '#10b981', icon: Activity,   description: 'Track liver enzyme and metabolic markers.' },
  'Kidney Function':             { color: '#06b6d4', icon: CircleDot,  description: 'Assess glomerular and tubular function.' },
